...
import com.sinophy.smartbracelet.mine.AccountAndSafeActivity;
import com.sinophy.smartbracelet.mine.DataRecordActivity;
import com.sinophy.smartbracelet.mine.UserInfoActivity;
...
import com.sinophy.smartbracelet.mine.AboutActivity;
import com.sinophy.smartbracelet.mine.HelpCenterActivity;
import com.sinophy.smartbracelet.mine.LoginActivity;
...
public class MineFragment extends BaseFragment {
    ...
    public void refreshUI() {
        model = DeviceManager.getInstance().currentModel;
        if (model == null) {
            return;
        }
